...
- **Operation of CNFs**: Set of best practices that helps CNF Operators for the life-cycle management of CNFs in a cloud native way (for example, deployment, configuration management, upgrade, etc).
